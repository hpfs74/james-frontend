...
module.exports = {
  link: [
    ...
    /** <link> tags for icons **/
    { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/assets/icon/android-icon-32x32.png' },
    { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icon/android-icon-96x96.png' },
    { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/assets/icon/android-icon-16x16.png' },

    /** <link> tags for a Web App Manifest **/
    { rel: 'manifest', href: '/assets/manifest.json' }
  ],
  meta: [
    { name: 'msapplication-TileColor', content: '#e85875' },
    { name: 'msapplication-TileImage', content: '/assets/icon/mstile-144x144.png', '=content': true },
    { name: 'theme-color', content: '#e85875' }
  ]
};
