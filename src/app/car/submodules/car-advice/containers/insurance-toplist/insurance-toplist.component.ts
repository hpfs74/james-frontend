...
export class InsuranceTopListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
     ...
     */
    this.orderBy = [
      {id: 'priceQuality', label: 'prijs / kwaliteit', key: 'price_quality', active: !this.featureConfigService.isOn('productOrder')},
      {id: 'price', label: 'beste prijs', key: 'monthly_premium', active: this.featureConfigService.isOn('productOrder')}
    ];
  }
