...
@Directive({ selector: '[knxClickOutside]' })
export class ClickOutsideDirective implements OnInit, OnChanges, OnDestroy {
  ...
  @Input() clickOutsideEvents: any = '';

  @Output() knxClickOutside: EventEmitter<Event> = new EventEmitter<Event>();
